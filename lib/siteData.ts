...
export const resumeData = {
    experience: [
        ...
        },
        {
            ...
            company: 'wipro',
            description: 'Led enterprise Data Warehouse and BI initiatives, delivering scalable analytics solutions that enhanced reporting performance and data reliability.',
        },
        {
            period: '2007 - 2010',
            title: 'Package Solution Consultant',
            company: 'ibm',
            description: 'Delivered enterprise Business Intelligence and data warehousing solutions, helping organizations transform operational data into actionable business insights.',
        },
    ],
    education: [
        {
